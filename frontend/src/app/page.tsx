...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050507] text-white font-mono overflow-x-hidden selection:bg-[#10B981] selection:text-black relative">
      ...
      {/* ─── Hero ─────────────────────────────────────────────────────────── */}
      <div id="main-content" className="relative min-h-screen w-full overflow-hidden flex items-center justify-center bg-[#050505]">
      ...
      <footer className="bg-black/40 backdrop-blur-sm border-t border-gray-800/40 py-16 px-8 md:px-16 relative z-40">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h3 className="text-white font-bold mb-6 tracking-widest uppercase text-xs">Networks</h3>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h3 className="text-white font-bold mb-6 tracking-widest uppercase text-xs">Links</h3>
            <ul className="space-y-4 flex flex-col">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h3 className="text-white font-bold mb-6 tracking-widest uppercase text-xs">Agents</h3>
            <ul className="space-y-4 flex flex-col">
